...
public class RedisConfig {
	...
	public RedisCacheManager cacheManager(RedisConnectionFactory connectionFactory) {
		RedisCacheConfiguration defaultConfiguration = baseConfiguration(Duration.ofMinutes(10));
		return RedisCacheManager.builder(connectionFactory)
				.cacheDefaults(defaultConfiguration)
				.withInitialCacheConfigurations(Map.of(
						"projects.by-id", baseConfiguration(Duration.ofMinutes(15)),
						"projects.public", baseConfiguration(Duration.ofMinutes(5)),
						"projects.members", baseConfiguration(Duration.ofMinutes(5))))
				.build();
	}
